...
echo "<br><p><a href='?force_admin=1' style='background: #fed000; color: white; padding: 10px 20px; text-decoration: none; border-radius: 8px;'>🚀 Forçar Login como Admin ID 1</a></p>";
?>
